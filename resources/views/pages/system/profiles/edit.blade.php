				...
				<div class="col-md-12">
					<div class="form-group form-inline">
						<div class="checkbox checkbox-primary pr-2">
							<input name="reports_operational_read"  id="reports_operational_read" type="checkbox" @if(json_decode($profile->acl_reports_operational)->read) checked @endif hidden>
							<label for="reports_operational_read">Relatórios Operacionais</label>
						</div>
						<div class="checkbox checkbox-primary pr-2">
							<input name="reports_administrative_read" id="reports_administrative_read" type="checkbox" @if(json_decode($profile->acl_reports_administrative)->read) checked @endif hidden>
		...
		<div class="collapse" id="Dashboards">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group form-inline">
						<div class="checkbox checkbox-primary pr-2">
							<input name="dashboards_management_read" id="dashboards_management_read" type="checkbox" @if(json_decode($profile->acl_dashboards_management)->read) checked @endif hidden>
							<label for="dashboards_management_read">Dashboard Gerencial</label>
						</div>
						<div class="checkbox checkbox-primary pr-2">
							<input name="dashboards_operational_read" id="dashboards_operational_read" type="checkbox" @if(json_decode($profile->acl_dashboards_operational)->read) checked @endif hidden>
